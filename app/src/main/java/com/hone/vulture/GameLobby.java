...
//Declare our variables.
    ...
    private String[] name = {"Dian1", "Dian2", "Dian3"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Assign the views from layout to the corresponding varible
        mAddFriend = (Button) findViewById(R.id.Add_Friend);
        mReady = (Button) findViewById(R.id.Ready);
        mQuite = (Button) findViewById(R.id.Quite);

        View.OnClickListener lister = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (view.getId() == R.id.Add_Friend) {
                    /*Intent intent = new Intent(GameLobby.this, AddFriend.class);//Intent to Add Friends
